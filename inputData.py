...
exp = "/home/giacomol/Desktop/Research/windLoading/LES/optimization/highRiseDomain/exp"
...
Iu_exp_min = numpy.sqrt(uu_exp_min)/U_exp
Iv_exp_min = numpy.sqrt(vv_exp_min)/U_exp
Iw_exp_min = numpy.sqrt(ww_exp_min)/U_exp

Iu_exp_max = numpy.sqrt(uu_exp_max)/U_exp
Iv_exp_max = numpy.sqrt(vv_exp_max)/U_exp
Iw_exp_max = numpy.sqrt(ww_exp_max)/U_exp
...
P_x = [0.04, 0.08, 0.30, 0.50, 2.00]

# Bezier points for uu (initial simulations)
P0_uu = [0.8, 1.5, 1.0, 0.8, 0.6]
P1_uu = [0.8, 3.0, 2.0, 1.6, 0.6]

# Bezier points for vv (initial simulations)
P0_vv = [0.1, 1.0, 0.6, 0.4, 0.4]
P1_vv = [0.1, 2.0, 1.2, 0.8, 0.4] 

# Bezier points for ww (initial simulations)
P0_ww = [0.3, 1.2, 0.8, 0.6, 0.4]
P1_ww = [0.3, 2.4, 1.6, 1.2, 0.4]

# Bezier points for ww (initial simulations)
P0_uv = [-0.1, -1.0, -0.6, -0.4, -0.4]
P1_uv = [-0.3, -2.0, -1.2, -0.8, -0.4]
'''
